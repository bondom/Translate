...
Insert into USER_TEST values(3,null,'20.04.1111','Rio',null,'COUNTRY','admin@mail.ru','CONFIRMED','Admin','Adminovych','$2a$10$n405gIRg0biC24NiZ/s9bODmsT2Az39xNRWI7q46siAeW1rmXn/ju','+380666112256','09.08.2016 17:47:21,969000000','ROLE_ADMIN','ACTIVE');
 Select * from AD_TEST; 
